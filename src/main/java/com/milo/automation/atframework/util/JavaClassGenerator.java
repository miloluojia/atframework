...
public class JavaClassGenerator {
    ...
    /**
     * @param className 需要生成的类名（目前暂时预设了几个方法和变量）
     * @return
     * @throws Exception
     */
    public static boolean createAndLoadClass(String className) throws Exception {
        ClassPool classPool = ClassPool.getDefault();
        CtClass ctClassUser = classPool.makeClass(className);
...
//        package com.milo.automation.atframework.DynamicTest;
//        /Users/milo/atframework/src/main/java/com/milo/automation/atframework/DynamicTest
        CtClass ctClassUser = classPool.makeClass("User");
